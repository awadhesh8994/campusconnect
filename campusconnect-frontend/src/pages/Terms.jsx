  ...
  const termsData = [
    {
      ...
      content: "By creating an account or using CampusConnect, you agree to comply with these Terms of Use and any applicable laws and regulations.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: UserCheck,
      title: "2. Eligibility",
      content: "CampusConnect is designed for use by current college students, faculty, and verified campus members. You must provide accurate information during registration and agree not to impersonate others.",
  ...
  const limitations = [
    {
      ...
      description: "Platform provided 'as is' without guarantees of uninterrupted service or uptime."
    },
    {
      icon: Users,
      title: "User Interactions",
      description: "Not responsible for disputes, conflicts, or interactions between platform users."
    },
    {
      icon: Upload,
      title: "Data Loss",
      description: "No liability for loss of user data, content, or any uploaded study materials."
    },
    {
      icon: MessageSquare,
      title: "Content Accuracy",
      description: "No responsibility for accuracy, completeness, or reliability of user-generated content."
    }
  ];
  ...
  const platformFeatures = [
    {
      ...
      description: "Connect with classmates through posts, comments, polls, and hashtag filtering"
    },
    {
      icon: BookOpen,
      title: "Study Materials",
      description: "Share and access academic resources, notes, and study guides with fellow students"
    },
    {
      icon: MessageSquare,
      title: "Real-time Chat",
      description: "Communicate instantly with Socket.IO powered messaging and group discussions"
    },
    {
      icon: Calendar,
      title: "Campus Events",
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Welcome to CampusConnect, a community platform built for college students and faculty to connect, 
            collaborate, and grow. By accessing or using our services, you agree to be bound by these Terms of Use.
          </p>
        ...
        <Card className="mb-16 shadow-xl border-0 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
          <CardContent className="p-12 text-center">
            ...
            <h2 className="text-3xl font-bold mb-4">Fair & Transparent Terms</h2>
            <p className="text-xl opacity-95 max-w-4xl mx-auto leading-relaxed">
              These terms ensure a safe, respectful, and productive environment for all students and faculty. 
              They're designed to protect your rights while maintaining our vibrant campus community.
            </p>
          </CardContent>
        </Card>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">What CampusConnect Offers</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our platform is designed to enhance your college experience through these core features.
            </p>
          </div>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Please read these terms carefully. They outline your rights and responsibilities as a CampusConnect user.
            </p>
          </div>
              ...
              <Card key={index} className="shadow-lg border-0 bg-white/70 backdrop-blur-sm hover:shadow-xl transition-all duration-300 group">
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    <div className={`w-12 h-12 rounded-xl bg-gradient-to-r ${term.color} flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300`}>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              While we strive to provide the best service, here are the limitations of our liability.
            </p>
          </div>
            ...
            {limitations.map((limitation, index) => (
              <Card key={index} className="shadow-lg border-0 bg-white/70 backdrop-blur-sm hover:shadow-xl transition-all duration-300 group">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">{limitation.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
        ...
        <Card className="mb-16 shadow-lg border-0 bg-white/70 backdrop-blur-sm">
          ...
          <CardContent className="space-y-4">
            <p className="text-gray-600">
              ...
              or to improve user experience. Here's how we handle updates:
            </p>
            
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-blue-50 rounded-lg p-4">
                <h4 className="font-semibold text-blue-900 mb-2">Notification</h4>
                <p className="text-blue-700 text-sm">We'll notify users of significant changes via email and platform announcements</p>
              </div>
              <div className="bg-purple-50 rounded-lg p-4">
                <h4 className="font-semibold text-purple-900 mb-2">Effective Date</h4>
                <p className="text-purple-700 text-sm">Changes become effective after the specified notice period</p>
              </div>
              <div className="bg-green-50 rounded-lg p-4">
                <h4 className="font-semibold text-green-900 mb-2">Acceptance</h4>
                <p className="text-green-700 text-sm">Continued use of the platform means you accept the updated terms</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mb-16 shadow-lg border-0 bg-white/70 backdrop-blur-sm">
          ...
          <CardContent className="space-y-4">
            <p className="text-gray-600">
              Your use of CampusConnect is also governed by our Privacy Policy, which outlines how we collect, 
              use, and protect your information. Both documents work together to ensure your rights and safety.
            </p>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              ...
              <p className="text-green-700 text-sm">
                We never sell your data and only use your information to enhance your campus experience. 
        ...
        <Card className="shadow-xl border-0 bg-gradient-to-r from-blue-50 to-purple-50">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
              If you have questions about these terms or need clarification about your rights and responsibilities, 
              our support team is here to help you navigate your campus community experience.
            </p>
            ...
            <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <div className="flex items-center justify-center gap-2 text-yellow-800">
                ...
                <span className="text-sm font-medium">
                  By using CampusConnect, you acknowledge that you have read, understood, and agree to these Terms of Use.
                </span>
              </div>
            </div>
          </CardContent>
