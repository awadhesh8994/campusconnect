...
const AboutPage = () => {
  const features = [
    {
      ...
      description:
        "Connect with fellow students, form study groups, and build lasting friendships across campus.",
    ...
    },
    {
      ...
      description:
        "Share thoughts, ask questions, and engage in meaningful discussions with your peers.",
    ...
    },
    {
      ...
      description:
        "Discover campus events, create your own gatherings, and never miss out on what's happening.",
    ...
    },
    {
      ...
      description:
        "Share resources, collaborate on projects, and support each other's academic journey.",
    ...
    },
    {
      ...
      description:
        "Enjoy a moderated, secure platform designed specifically for student communities.",
    ...
    },
    {
      ...
      description:
        "Stay connected with instant notifications and live updates from your campus community.",
  ...
  const founder = {
    ...
    social: {
      ...
      linkedin: "https://www.linkedin.com/in/awadhesh-kumar-615088265/",
  ...
  const values = [
    {
      ...
      description:
        "We believe in the power of authentic connections and supportive communities.",
    },
    {
      icon: Target,
      title: "Student-Focused",
      description:
        "Every feature is designed with student needs and experiences in mind.",
    },
    {
      icon: Lightbulb,
      title: "Innovation",
      description:
        "We continuously evolve to provide the best tools for campus connection.",
    },
    {
      icon: Globe,
      title: "Inclusivity",
      description:
        "We create spaces where every student feels welcome and valued.",
    },
  ];
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            CampusConnect is more than just a social platform—it's a digital
            home where students come together to share, learn, and grow. We're
            building the future of campus community engagement.
          </p>
        </div>
        ...
        <Card className="mb-16 shadow-xl border-0 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-xl opacity-95 max-w-4xl mx-auto leading-relaxed">
              To empower students worldwide by creating meaningful connections,
              fostering collaboration, and building vibrant campus communities
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Discover the features that make CampusConnect the perfect platform
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              The visionary behind CampusConnect, dedicated to building stronger
              campus communities.
            </p>
          </div>
            ...
            <Card className="max-w-md shadow-lg border-0 bg-white/70 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
              <CardContent className="p-8 text-center">
                <Avatar className="h-32 w-32 mx-auto mb-6 ring-4 ring-blue-100">
                  <AvatarImage
                    src={"/profile-img_11zon-compressed-compressed.jpeg"}
                    alt={founder.name}
                  />
        ...
        <Card className="shadow-xl border-0 bg-gradient-to-r from-blue-50 to-purple-50">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
              Join thousands of students who are already building amazing
              communities on CampusConnect. Your campus community is waiting for
              you.
            </p>
