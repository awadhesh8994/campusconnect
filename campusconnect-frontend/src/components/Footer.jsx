        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 text-lg mb-6 max-w-md">
              Connecting your campus community through shared knowledge,
              exciting events, and meaningful connections.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="/"
                  className="text-gray-300 hover:text-indigo-300 transition-colors duration-200 flex items-center space-x-2"
                >
              ...
              <li>
                <a
                  href="/study-notes"
                  className="text-gray-300 hover:text-pink-300 transition-colors duration-200 flex items-center space-x-2"
                >
                  <span className="text-sm">📚</span>
              ...
              <li>
                <a
                  href="/search"
                  className="text-gray-300 hover:text-teal-300 transition-colors duration-200 flex items-center space-x-2"
                >
                  <span className="text-sm">🔍</span>
                  <span>Search</span>
                </a>
