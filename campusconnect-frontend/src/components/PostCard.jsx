...
export default function PostCard({ post, currentUserId }) {
  ...
  const token = 'demo_token'; // Using demo token since localStorage isn't available
      ...
      <div className="mb-4">
        ...
        {post.image && (
          <img
            ...
            onError={(e) => (e.target.src = 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&h=400&fit=crop')}
          />
        )}
      </div>
